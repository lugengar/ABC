...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-09-2024 a las 06:18:45
...
(19, 'Instituto Superior de Formación Docente y Técnica Nº 52 Sede en los Ceibos', 'AVC, Los Ceibos 52, B1609AVC Boulogne, Provincia d', '', 'Instituto', '0000', '', 3, 0),
(20, 'Instituto Superior de Formación Docente y Técnica Nº 52 Sede Martin y Omar', 'B1642DHE, Martin y Omar 255, B1642DHE San Isidro, ', '', '', '0000', '', 3, 0);
...
(98, 'actuarioadmeconómicasuba', 73, 15),
(99, 'contadoreconómicasuba', 74, 15),
(100, 'administracióneconómicasuba', 75, 15),
(101, 'economíaeconómicasuba', 76, 15),
(102, 'sistemaseconómicasuba', 77, 15),
(103, 'actuarioecoeconómicasuba', 78, 15),
(104, 'licpsicologiauba', 79, 15),
(105, 'licmusicoterapiauba', 80, 15),
(106, 'licterapiaocupacionaluba', 81, 15),
(107, 'profenseñanzamediasuperiorpsicologiauba', 82, 15),
(108, 'licrelacionestrabajouba', 83, 15);
...
--
ALTER TABLE `carrera`
  MODIFY `id_carrera` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;
...
--
ALTER TABLE `planestudio`
  MODIFY `id_planestudio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;
