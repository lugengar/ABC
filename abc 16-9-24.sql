...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-09-2024 a las 03:43:38
...
(114, 'Formación Profesional de Carrera de Enfermería', 'Capacitación profesional para el ejercicio de la enfermería en centros de salud y hospitales.', 'Enfermero Profesional', 'otros'),
...
--
ALTER TABLE `carrera`
  MODIFY `id_carrera` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;
